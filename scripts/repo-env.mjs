...
export const composeProjectName =
  process.env.COMPOSE_PROJECT_NAME ?? `oculus-business-${repositoryHash}`
/**
...
export function defaultTestDatabaseUrl(port = defaultPostgresTestPort) {
  return `postgresql://superuser:superpassword@localhost:${port}/oculus_business_test?schema=public`
}
