...
docker compose --env-file backend/.env exec postgres pg_isready -U superuser -d oculus_business
```
...
host: localhost
port: 54329
database: oculus_business
user: superuser
password: superpassword
DATABASE_URL: postgresql://superuser:superpassword@localhost:54329/oculus_business?schema=public
```
...
host: localhost
port: 54330
database: oculus_business_test
user: superuser
password: superpassword
TEST_DATABASE_URL: postgresql://superuser:superpassword@localhost:54330/oculus_business_test?schema=public
```
