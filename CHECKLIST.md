...
| Question                                                  | Answer       |
| --------------------------------------------------------- | ------------ |
| What product do you want to build first?                  | Мобильное веб-приложение для ведения бизнеса ОРДИКС/OCULUS: 1) CRM с канбан-доской сделок, 2) учёт доходов и расходов (разовых и ежемесячных) с прогнозом и runway, 3) канбан-доска доработок и багов продукта |
...
| Question                                                                                                             | Answer       |
| -------------------------------------------------------------------------------------------------------------------- | ------------ |
| Why the unmarked surfaces are deferred, if it needs explaining                                                       | Инструмент только для команды ОРДИКС за логином; публичных SEO-страниц нет. Нативное мобильное приложение — позже: владелец попросил «онлайн на бесплатном хостинге, смотреть и дорабатывать по ссылке», это даёт веб-приложение с мобильным интерфейсом; ветка `mobile` остаётся нетронутой до решения владельца. |
