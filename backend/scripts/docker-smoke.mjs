...
const imageName = process.env.BACKEND_DOCKER_SMOKE_IMAGE ?? 'oculus-business-backend:smoke'
const containerName =
  process.env.BACKEND_DOCKER_SMOKE_CONTAINER ??
  `oculus-business-backend-smoke-${repositoryHash}-${process.pid}`
...
const databaseUrlForContainer =
  ...
  'postgresql://superuser:superpassword@postgres_test:5432/oculus_business_test?schema=public'
