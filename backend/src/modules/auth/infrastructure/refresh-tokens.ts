...
const familyPurpose = 'oculus-business:refresh-family:v1\0'
const familyTagPurpose = 'oculus-business:refresh-family-tag:v1\0'
const rotationPurpose = 'oculus-business:refresh-rotation:v1\0'
