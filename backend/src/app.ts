...
import { createBusinessModule } from './modules/business'
...
export function createApp({
  ...
  const business = createBusinessModule({ db: prisma, requireAuth: auth.requireAuth })
  ...
  app.route('/api/crm', business.crm)
  app.route('/api/dev', business.dev)
  app.route('/api/finance', business.finance)
  app.route('/api/dashboard', business.dashboard)
